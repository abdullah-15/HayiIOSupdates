...
class FUser {
    ...
    init(_dictionary: NSDictionary) {
        ...
        if let suserId = _dictionary[kServerUserId] {
            serverUserId = suserId as! Int
        }
        else {
            serverUserId = 0
        }
        if let fcmToken = _dictionary[kFCMToken] {
...
func updateServerUserId(withValues : [String : Any], completion: @escaping (_ error: Error?) -> Void) {
...
func updateAvatar(withValues : [String : Any], completion: @escaping (_ error: Error?) -> Void){
